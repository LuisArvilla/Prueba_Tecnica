...
def crear_paciente():
    ...
    try:
        ...
        if 'database is locked' in str(e).lower():
            print("⚠️ Base de datos ocupada. No se pudo guardar el paciente.")
            return jsonify({'error': 'Base de datos ocupada. Intenta de nuevo.'}), 503
        else:
            print("❌ Error de base de datos:", str(e))
            return jsonify({'error': 'Error interno al guardar el paciente.'}), 500
